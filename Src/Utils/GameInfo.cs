...
namespace TeamRock.Utils
{
    public static class GameInfo
    {
        ...
        // Center Board
        private const int CenterBoardWidth = 480;

        // Player State
        public const float PlayerMinYPosition = 10;
        public const float PlayerMaxYPosition = WindowHeight - 10;
        public const float PlayerAssetScale = 0.2f;
        public static readonly Vector2 PlayerInitialPosition = new Vector2(WindowWidth / 2.0f, 50);
        ...
        public const int PlayerRightPosition = WindowWidth - AudienceWidth;
